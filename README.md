# ScanSegmenter
<p align="center">
  <strong>ScanSegmenter(and also merge the scan results)</strong>
</p>


---

**S**can**S**egmenter is used to efficiently automate port scanning routine by splitting it into 3 phases:
...
To successfully *scanSegmentor* we need to get some good port scanning tools (in the examples below GitHub releases are grabbed via [eget](https://github.com/zyedidia/eget)).
